<?php 
	...
	date_default_timezone_set("Asia/jakarta");
		...
		// include 'phpmailer/src/Exception.php';	//arahkan ke folder phpmailer
		// include 'phpmailer/src/PHPMailer.php';	//arahkan ke folder phpmailer
		// include 'phpmailer/src/SMTP.php';	//arahkan ke folder phpmailer
		// include 'phpmailer/class.phpmailer.php';	//arahkan ke folder phpmailer
		// include 'phpmailer/PHPMailerAutoload.php';	//arahkan ke folder phpmailer
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../lg.png" alt="logoo" width="100%"></a>
            </div>
            <div class="main-menu">
											...
											if(isset($_POST["schedule"])){
													...
													$intview = mysqli_query($conn,"insert into applicant_scheduling values('','$ids','$alamat','$tanggal','$pic','$telp');");
														if($intview){
																...
																$mail->SMTPAuth = true;
																$mail->Username = 'nakawaaddmin@gmail.com';						/////////////////////// ISI DENGAN ALAMAT GMAIL KALIAN
																$mail->Password = 'nwrbrpwinptxjpwd';						/////////////////////// ISI DENGAN PASSWORD GMAIL NYA
																
																//Recipients
																$mail->setFrom('nakawajob@gmail.com', 'Job Application');
...
<!-- market value area start -->
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable2" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$job=mysqli_query($conn,"SELECT * FROM applicant as a 
											RIGHT JOIN applicant_scheduling as b ON a.applicant_id = b.applicant_id 
											where a.applicant_position!='title' and a.action='1' order by a.applicant_id ASC");
											$no=1;
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<form action="applicant.php" method="POST">	
																				...
																				<div class="form-group">
																					<label>Nama Posisi</label>
																					<input type="text" name="posisi" class="form-control" value="<?php echo $posisi ?>" readonly>
																				</div>
																				<div class="form-group">
																					<label>Pendidikan</label>
																					<input type="text" class="form-control" value="<?php echo $edu ?>" disabled>
																				...
																				<div class="form-group">
																					<label>Kemampuan</label>
																					<input type="text" class="form-control" value="<?php echo $spe ?>" readonly>
																				</div>
																				<div class="form-group">
																					<label>Info Tambahan</label>
																					<input type="text" class="form-control" value="<?php echo $info ?>" readonly>
																				</div>
																				<div class="form-group">
																					<label>Alamat</label>
																					<input type="text"name="alamat" class="form-control" value="<?php echo $adr ?>" readonly>
																				</div>
																				<div class="form-group">
																					<label>No.Telepon</label>
																					<input type="text" name="telp" class="form-control" value="<?php echo $phone ?>" readonly>
																				</div>
																				<div class="form-group">
																					<label>Email</label>
																				...
																				<div class="form-group">
																					<label>Tanggal submit</label>
																					<input type="datetime"name="tanggal" class="form-control" value="<?php echo $submit ?>" readonly>
																				</div>
																				<div class="form-group">
																				<label>Bertemu dengan (PIC)</label>
																				<input type="text" class="form-control" value="<?php echo $pic ?>" name="pic" required>
																			</div>
																			<div class="form-group">
																				<label>No Telp PIC</label>
																				<input type="text" class="form-control" value="<?php echo $telp ?>" name="telp" required>
																			</div>
																			</div>
																			<div class="modal-footer">
																				<input type="submit" name="diterima" class="btn btn-primary" value="Diterima">
																			</div>
											...
											if(isset($_POST["diterima"])){
												...
												// $pic = $_POST['pic'];
												// $telp = $_POST['telp'];
												$intview = mysqli_query($conn,"INSERT into applicant_scheduling values('','$id','$alamat','$tanggal','$pic','$telp');");
												...
												echo "<script type='text/javascript'>alert('$message');</script>";
															...
															mysqli_query($conn,"UPDATE applicant where applicant_id='$id'");
															...
															$mail->SMTPAuth = true;
															$mail->Username = 'nakawaaddmin@gmail.com';						/////////////////////// ISI DENGAN ALAMAT GMAIL KALIAN
															$mail->Password = 'cwlbhfapnftsnihi';						/////////////////////// ISI DENGAN PASSWORD GMAIL NYA
															
															//Recipients
															$mail->setFrom('nakawajob@gmail.com', 'Job Application');
															$mail->addAddress ($email, $nama1);     // Add a recipient
															$mail->addReplyTo('nakawaaddmin@gmail.com', 'Job Application');
															$mail->Subject = 'Hi, ' . $nama1 . '! Anda diterima di posisi '.$posisi1.' in our company';
															// Mengatur format email ke HTML
															$mail->isHTML(true);
															// Konten/isi email
															$mailContent = '
        ...
        <footer>
            <div class="footer-area">
                <p>By Jamalludin@raharja.info</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
