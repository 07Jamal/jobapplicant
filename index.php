...
<html>
    ...
    <body style="font-family:verdana">
        ...
        <div class="wraper">
            ...
            <!-- header end -->
            <!-- slider start -->
            <div style="background-image:url('bu.jpeg');background-repeat:no-repeat; width:100%; height:420px;background-position:center;background-size:cover;">
                <div class="container-fluid text-center">
                    <div class="slider-text" style="margin-top:7%; margin-left:45%;">
                        <h2 style="color:white; font-family:verdana">NakawaJob</h2>
