...
-- Table structure for table 'applicant_diterima'
--
...
-- Table structure for table 'applicant_ditolak'
--

CREATE TABLE 'applicant_ditolak'(
  'id' int (11) NOT NULL,
  'applicant_id' int(11) DEFAULT NULL,
  'alamat' text DEFAULT NULL,
  'pic' varchar(50) NOT NULL,
...
--
-- Indexes for table 'applicant_diterima'
--
ALTER Table 'applicant_diterima'
  ADD PRIMARY KEY ('id'),
  ADD KEY 'Fk_applicant_id' ('applicant_id');


  --
  -- Idexes for table 'applicant_diterima'
  --
  ALTER Table 'applicant_ditolak'
    ADD PRIMARY KEY ('id'),
    applicant_address KEY 'Fk_applicant_id' ('applicant_id');
